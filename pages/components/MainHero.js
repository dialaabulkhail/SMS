  ...
  return (
    <>
      {thank ? (
        ...
        <div className=" h-screen w-full bg-cover lg:bg-[url(https://storage.cloudconvert.com/tasks/ac23d26c-3900-4749-9775-0b939eeaa46c/iphone_14_banner.webp?AWSAccessKeyId=cloudconvert-production&Expires=1666168187&Signature=289yESPDy7wXXDIfWurrykbh39M%3D&response-content-disposition=inline%3B%20filename%3D%22iphone_14_banner.webp%22&response-content-type=image%2Fwebp)] flex bg-fixed bg-center flex items-center justify-center bg-[url(https://www.apple.com/lae/iphone-14-pro/images/overview/design/design_startframe__cffzwjeyro2q_large.jpg)]">
          <div className="absolute top-16 left-0 right-0 bottom-0 bg-black/70 h-screen" />
